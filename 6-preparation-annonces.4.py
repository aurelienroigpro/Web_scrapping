...
# --------------------------------------------------
# 🔎 PRÉLECTURE : villes avec > 35 annonces
# --------------------------------------------------
...
for i, row in df_filtre.iterrows():
    ...
    ligne = {
        ...
        "surface": row["surface"],
        "pieces": row["pieces"],
        "type_bien": "Appartement" if row["type_bien"] == "Duplex" else row["type_bien"],
